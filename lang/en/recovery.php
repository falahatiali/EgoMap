...
return [
    ...
    'triage_subtitle' => 'Four quick questions. No signup. One clear direction.',
    'question_label' => 'Question :current of :total',
    'back' => 'Back',

    'q_relationship_title' => 'How long were you together?',
    'q_relationship_subtitle' => 'Timeline shapes how deep the pattern ran.',
    'q1_title' => 'How long since the breakup?',
    'q1_subtitle' => 'Be honest — the timeline shapes your nervous system.',
    'q3_title' => 'Who ended the relationship?',
    'q3_subtitle' => 'No judgment — we need the power dynamic.',
    'q2_title' => 'What is your biggest struggle right now?',
    'q2_subtitle' => 'Pick the one that hits hardest today.',

    'rel_under_6_months' => 'Under 6 months',
    'rel_six_to_twelve' => '6–12 months',
    'rel_one_to_three_years' => '1–3 years',
    'rel_three_plus_years' => '3+ years',

    'initiator_me' => 'I ended it',
    'initiator_them' => 'They ended it',
    'initiator_mutual' => 'Mutual / unclear',
    ...
    'struggle_worthless' => 'Hopelessness or feeling worthless',
    'struggle_anger' => 'Anger and rage',
    'struggle_get_back' => 'Trying to get them back',

    'diagnosis_loading_title' => 'Reading your pattern…',
    'diagnosis_loading_body' => 'Mapping what your answers mean — one prescription, not a buffet.',
    ...
    'plan_diagnosis_stalking_body' => 'Checking their profile is not “staying informed” — it is re-injecting the drug. Your defense system is hacked.',
    'plan_why_stalking' => 'Why? Every story view trains your brain to wait for crumbs. We break the signal before you drown in breadcrumbs.',
    ...
    'plan_why_anger' => 'Why? Cut contact first. Vent in safe tools later — not in their DMs.',
