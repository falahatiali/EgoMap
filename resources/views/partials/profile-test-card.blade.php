...
<div class="col-md-6 col-xl-4">
    <div class="eg-profile-test-card eg-glass">
        <header class="eg-profile-test-card-top">
            ...
            <button
                ...
                wire:click="deleteSession('{{ $record['session']->uuid }}')"
                wire:confirm="{{ __('profile.delete_test_confirm') }}"
        ...
        <a href="{{ $record['detail_url'] }}" class="eg-profile-test-card-link" wire:navigate>
